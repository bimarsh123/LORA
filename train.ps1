...
$output_name = "./output" # output model name | 模型保存名称
$save_model_as = "safetensors" # model save ext | 模型保存格式 ckpt, pt, safetensors
$destinationDir = "D:\code\stable-diffusion-webui\models\Lora"
...
if (Test-Path $destinationDir){
  ...
  Write-Output "Destination folder does not exists"
  New-Item -ItemType Directory -Force -Path $destinationDir
}
# Build completed file path
